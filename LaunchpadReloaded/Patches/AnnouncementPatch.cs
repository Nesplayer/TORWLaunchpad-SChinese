...
#pragma warning restore S1075 // URIs should not be hardcoded
    ...
    public static IEnumerator FetchNews()
    {
        ...
        {
            downloaded = false;
            Logger<LaunchpadReloadedPlugin>.Error($"Couldn't fetch mod news from github: {request.error}");
        ...
        {
            Logger<LaunchpadReloadedPlugin>.Error(
    ...
    private static void LoadModNewsFromResources()
    {
        ...
        using var resourceStream =
            assembly.GetManifestResourceStream("LaunchpadReloaded.Resources.Announcements.modNews-" + filename)
            ?? throw new InvalidOperationException(
                $"Resource not found: LaunchpadReloaded.Resources.Announcements.modNews-{filename}");
    ...
    {
        public static ImmutableList<ModNews> AllModNews = ImmutableList<ModNews>.Empty;
        ...
        public static void SetModAnnouncements_Prefix(ref Il2CppReferenceArray<Announcement> aRange)
        {
            ...
            {
                Logger<LaunchpadReloadedPlugin>.Error($"No mod news were found.");
                return;
            }
